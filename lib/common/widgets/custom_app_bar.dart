...
class CustomAppBarWidget extends StatelessWidget
  ...
  final Color? showBackButtonColor;
  final Widget? title;
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      //   statusBarColor: context.customTheme.primary,
  ...
  Size get preferredSize => Size.fromHeight(
    FigmaDesign.toolbarHeight + (bottom?.preferredSize.height ?? 0),
  );
}
